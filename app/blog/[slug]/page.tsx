    ...
    <MarketingPageShell>
      ...
      <article className="border-b border-border bg-background pt-28 pb-16 lg:pt-32">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-dark sm:text-4xl text-balance">
            {post.title}
          </h1>
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <aside className="mt-16 border-t border-border pt-10">
          <p className="text-sm font-semibold text-dark">Explore JobTap</p>
          <ul className="mt-4 space-y-2 text-sm">
            <li>
              <Link href="/interview-assistant" className="text-primary hover:underline">
                AI Interview Assistant
              </Link>
            </li>
            <li>
              <Link href="/meeting-translator" className="text-primary hover:underline">
        ...
        {related.length > 0 ? (
          <aside className="mt-12">
            <h2 className="text-lg font-bold text-dark">More from the blog</h2>
